...
def test_assign_permission_crud_journey(
    ...
    assign_permission_app.assign_permission_page.search_assign_permission_by_member(
        data.second_member
    )
    ...
    assign_permission_app.assign_permission_page.delete_assign_permission(
        data.updated_role_code
    )
    assign_permission_app.assign_permission_page.verify_assign_permission_deleted(
        data.updated_role_code
    )
