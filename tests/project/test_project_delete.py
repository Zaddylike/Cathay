...
def test_project_delete_success(project_app: OmniApp, created_project):
    project_app.project_page.open_project_delete_dialog(created_project.abbreviation)
    ...
    project_app.project_page.verify_project_deleted(created_project.abbreviation)
