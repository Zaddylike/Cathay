...
def test_project_crud_journey(project_app: OmniApp, project_data, project_cleanup):
    ...
    project_app.project_page.search_project_by_abbreviation(project_data.project_abbreviation)
    project_app.project_page.search_project_by_zh_name(project_data.zh_name)
    project_app.project_page.open_project_edit_form(project_data.project_abbreviation)
    ...
    project_app.project_page.delete_project(project_data.project_abbreviation)
    project_app.project_page.verify_project_deleted(project_data.project_abbreviation)
